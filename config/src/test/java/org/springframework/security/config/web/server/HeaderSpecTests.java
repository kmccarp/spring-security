...
public class HeaderSpecTests {
	...
	public void headersWhenDisableInLambdaThenNoSecurityHeaders() {
		new HashSet<>(this.expectedHeaders.keySet()).forEach(this::expectHeaderNamesNotPresent);
		this.http.headers(org.springframework.security.config.web.server.ServerHttpSecurity.HeaderSpec::disable);
		assertHeaders();
	}
	...
	public void headersWhenCacheDisableInLambdaThenCacheNotWritten() {
		...
		this.http.headers(headers -> headers
				.cache(org.springframework.security.config.web.server.ServerHttpSecurity.HeaderSpec.CacheSpec::disable)
		);
		// @formatter:on
		assertHeaders();
	}
	...
	public void headersWhenContentOptionsDisableInLambdaThenContentTypeOptionsNotWritten() {
		...
		this.http
				.headers(headers -> headers
						.contentTypeOptions(org.springframework.security.config.web.server.ServerHttpSecurity.HeaderSpec.ContentTypeOptionsSpec::disable
				));
		// @formatter:on
		assertHeaders();
	}
	...
	public void headersWhenHstsDisableInLambdaThenHstsNotWritten() {
		...
		// @formatter:off
		this.http.headers(headers -> headers
				.hsts(org.springframework.security.config.web.server.ServerHttpSecurity.HeaderSpec.HstsSpec::disable)
		);
		// @formatter:on
		assertHeaders();
	}
	...
	public void headersWhenFrameOptionsDisableInLambdaThenFrameOptionsNotWritten() {
		...
		// @formatter:off
		this.http.headers(headers -> headers
				.frameOptions(org.springframework.security.config.web.server.ServerHttpSecurity.HeaderSpec.FrameOptionsSpec::disable
				)
		);
		// @formatter:on
		assertHeaders();
	...
	public void headersWhenXssProtectionDisableInLambdaThenXssProtectionNotWritten() {
		...
		// @formatter:off
		this.http.headers(headers -> headers
				.xssProtection(org.springframework.security.config.web.server.ServerHttpSecurity.HeaderSpec.XssProtectionSpec::disable
				)
		);
		// @formatter:on
		assertHeaders();
